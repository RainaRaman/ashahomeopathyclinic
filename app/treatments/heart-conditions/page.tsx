...
export const metadata = {
  title: 'Heart Conditions | Asha Homeopathic Clinic',
...
export default function HeartConditionsPage() {
  return (
    <TreatmentLayout
      ...
      subtitle="Supportive homeopathic care for various heart conditions"
      mainImage="/images/services/heart-conditions.png"
      clinicImage="/images/clinic/aboutclinic_1.png"
    >
      <div className="space-y-8">
        <section>
          <h2 className="text-3xl font-bold text-primary mb-4">Understanding Heart Conditions</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            Heart Conditions is a common health condition that affects many people. At Asha Homeopathic Clinic, we provide holistic treatment that addresses the root cause of this condition through natural remedies.
          </p>
        </section>
