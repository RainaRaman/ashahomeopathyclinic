...
export const metadata = {
  title: 'Kidney Stone Treatment | Asha Homeopathic Clinic',
  description: 'Homeopathic treatment for kidney stones and urinary disorders',
};

export default function KidneyStonePage() {
  return (
    <TreatmentLayout
      title="Kidney Stone Treatment"
      subtitle="Homeopathic treatment for kidney stones and urinary disorders"
      mainImage="/images/services/kidney-stone.png"
      clinicImage="/images/clinic/aboutclinic_1.png"
    >
      <div className="space-y-8">
        <section>
          <h2 className="text-3xl font-bold text-primary mb-4">Understanding Kidney Stone Treatment</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            Kidney Stone Treatment is a common health condition that affects many people. At Asha Homeopathic Clinic, we provide holistic treatment that addresses the root cause of this condition through natural remedies.
          </p>
        </section>
