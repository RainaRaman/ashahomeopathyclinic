...
export const metadata = {
  title: 'Youth Counselling | Asha Homeopathic Clinic',
...
export default function YouthCounsellingPage() {
  return (
    <TreatmentLayout
      ...
      subtitle="Professional counseling for youth and adolescents"
      mainImage="/images/services/youth-counselling.png"
      clinicImage="/images/clinic/aboutclinic_1.png"
    >
      <div className="space-y-8">
        <section>
          <h2 className="text-3xl font-bold text-primary mb-4">Understanding Youth Counselling</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            Youth Counselling is a common health condition that affects many people. At Asha Homeopathic Clinic, we provide holistic treatment that addresses the root cause of this condition through natural remedies.
          </p>
        </section>
