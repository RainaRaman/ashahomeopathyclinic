...
export const metadata = {
  title: 'Cysts Treatment | Asha Homeopathic Clinic',
  description: 'Homeopathic treatment for various types of cysts',
};

export default function CystsPage() {
  return (
    <TreatmentLayout
      title="Cysts Treatment"
      subtitle="Homeopathic treatment for various types of cysts"
      mainImage="/images/services/cysts.png"
      clinicImage="/images/clinic/aboutclinic_1.png"
    >
      <div className="space-y-8">
        <section>
          <h2 className="text-3xl font-bold text-primary mb-4">Understanding Cysts Treatment</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            Cysts Treatment is a common health condition that affects many people. At Asha Homeopathic Clinic, we provide holistic treatment that addresses the root cause of this condition through natural remedies.
          </p>
        </section>
