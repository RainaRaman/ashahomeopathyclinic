...
export const metadata = {
  title: 'Skin Disorder | Asha Homeopathic Clinic',
  description: 'Comprehensive treatment for various skin disorders',
};

export default function SkinDisorderPage() {
  return (
    <TreatmentLayout
      title="Skin Disorder"
      subtitle="Comprehensive treatment for various skin disorders"
      mainImage="/images/services/skin-disorder.png"
      clinicImage="/images/clinic/aboutclinic_1.png"
    >
      <div className="space-y-8">
        <section>
          <h2 className="text-3xl font-bold text-primary mb-4">Understanding Skin Disorder</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            Skin Disorder is a common health condition that affects many people. At Asha Homeopathic Clinic, we provide holistic treatment that addresses the root cause of this condition through natural remedies.
          </p>
        </section>
