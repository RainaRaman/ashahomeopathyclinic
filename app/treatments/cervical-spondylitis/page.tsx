...
export const metadata = {
  title: 'Cervical Spondylitis Treatment | Asha Homeopathic Clinic',
  description: 'Effective homeopathic care for cervical spine issues',
};

export default function CervicalSpondylitisPage() {
  return (
    <TreatmentLayout
      title="Cervical Spondylitis Treatment"
      subtitle="Effective homeopathic care for cervical spine issues"
      mainImage="/images/services/cervical-spondylitis.png"
      clinicImage="/images/clinic/aboutclinic_1.png"
    >
      <div className="space-y-8">
        <section>
          <h2 className="text-3xl font-bold text-primary mb-4">Understanding Cervical Spondylitis Treatment</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            Cervical Spondylitis Treatment is a common health condition that affects many people. At Asha Homeopathic Clinic, we provide holistic treatment that addresses the root cause of this condition through natural remedies.
          </p>
        </section>
