...
export const metadata = {
  title: 'Bronchial Asthma Treatment | Asha Homeopathic Clinic',
  description: 'Natural homeopathic treatment for asthma and respiratory issues',
};

export default function BronchialAsthmaPage() {
  return (
    <TreatmentLayout
      title="Bronchial Asthma Treatment"
      subtitle="Natural homeopathic treatment for asthma and respiratory issues"
      mainImage="/images/services/bronchial-asthma.png"
      clinicImage="/images/clinic/aboutclinic_1.png"
    >
      <div className="space-y-8">
        <section>
          <h2 className="text-3xl font-bold text-primary mb-4">Understanding Bronchial Asthma Treatment</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            Bronchial Asthma Treatment is a common health condition that affects many people. At Asha Homeopathic Clinic, we provide holistic treatment that addresses the root cause of this condition through natural remedies.
          </p>
        </section>
