...
export const metadata = {
  title: 'Psychological Problems Adult Counselling | Asha Homeopathic Clinic',
...
export default function PsychologicalProblemsPage() {
  return (
    <TreatmentLayout
      title="Psychological Problems Adult Counselling"
      subtitle="Professional counseling and homeopathic care for adult psychological issues"
      mainImage="/images/services/psychological-problems.png"
      clinicImage="/images/clinic/aboutclinic_1.png"
    >
      <div className="space-y-8">
        <section>
          <h2 className="text-3xl font-bold text-primary mb-4">Understanding Psychological Problems Adult Counselling</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            Psychological Problems Adult Counselling is a common health condition that affects many people. At Asha Homeopathic Clinic, we provide holistic treatment that addresses the root cause of this condition through natural remedies.
          </p>
        </section>
