...
export const metadata = {
  title: 'Weight Loss Diet Counseling | Asha Homeopathic Clinic',
...
export default function WeightLossDietPage() {
  return (
    <TreatmentLayout
      ...
      subtitle="Personalized diet plans and counseling for healthy weight management"
      mainImage="/images/services/weight-loss-diet.png"
      clinicImage="/images/clinic/aboutclinic_1.png"
    >
      <div className="space-y-8">
        <section>
          <h2 className="text-3xl font-bold text-primary mb-4">Understanding Weight Loss Diet Counseling</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            Weight Loss Diet Counseling is a common health condition that affects many people. At Asha Homeopathic Clinic, we provide holistic treatment that addresses the root cause of this condition through natural remedies.
          </p>
        </section>
