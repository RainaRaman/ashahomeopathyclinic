...
export const metadata = {
  title: 'Joints and Musculoskeletal Disorders | Asha Homeopathic Clinic',
  description: 'Effective treatment for joint and musculoskeletal problems',
};

export default function JointsMusculoskeletalPage() {
  return (
    <TreatmentLayout
      title="Joints and Musculoskeletal Disorders"
      subtitle="Effective treatment for joint and musculoskeletal problems"
      mainImage="/images/services/joints-musculoskeletal.png"
      clinicImage="/images/clinic/aboutclinic_1.png"
    >
      <div className="space-y-8">
        <section>
          <h2 className="text-3xl font-bold text-primary mb-4">Understanding Joints and Musculoskeletal Disorders</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            Joints and Musculoskeletal Disorders is a common health condition that affects many people. At Asha Homeopathic Clinic, we provide holistic treatment that addresses the root cause of this condition through natural remedies.
          </p>
        </section>
