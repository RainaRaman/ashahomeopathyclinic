...
export const metadata = {
  title: 'Eczema Treatment | Asha Homeopathic Clinic',
...
export default function EczemaPage() {
  return (
    <TreatmentLayout
      ...
      subtitle="Natural remedies for eczema and chronic skin conditions"
      mainImage="/images/services/eczema.png"
      clinicImage="/images/clinic/aboutclinic_1.png"
    >
      <div className="space-y-8">
        <section>
          <h2 className="text-3xl font-bold text-primary mb-4">Understanding Eczema Treatment</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            Eczema Treatment is a common health condition that affects many people. At Asha Homeopathic Clinic, we provide holistic treatment that addresses the root cause of this condition through natural remedies.
          </p>
        </section>
