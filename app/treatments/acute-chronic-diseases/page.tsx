...
export const metadata = {
  title: 'Acute and Chronic Diseases | Asha Homeopathic Clinic',
  description: 'Comprehensive homeopathic treatment for acute and chronic conditions',
};

export default function AcuteChronicDiseasesPage() {
  return (
    <TreatmentLayout
      title="Acute and Chronic Diseases"
      subtitle="Comprehensive homeopathic treatment for acute and chronic conditions"
      mainImage="/images/services/acute-chronic-diseases.png"
      clinicImage="/images/clinic/aboutclinic_1.png"
    >
      <div className="space-y-8">
        <section>
          <h2 className="text-3xl font-bold text-primary mb-4">Understanding Acute and Chronic Diseases</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            Acute and Chronic Diseases is a common health condition that affects many people. At Asha Homeopathic Clinic, we provide holistic treatment that addresses the root cause of this condition through natural remedies.
          </p>
        </section>
