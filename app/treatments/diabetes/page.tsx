...
export const metadata = {
  title: 'Diabetes Management | Asha Homeopathic Clinic',
...
export default function DiabetesPage() {
  return (
    <TreatmentLayout
      ...
      subtitle="Holistic homeopathic approach to diabetes management"
      mainImage="/images/services/diabetes.png"
      clinicImage="/images/clinic/aboutclinic_1.png"
    >
      <div className="space-y-8">
        <section>
          <h2 className="text-3xl font-bold text-primary mb-4">Understanding Diabetes Management</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            Diabetes Management is a common health condition that affects many people. At Asha Homeopathic Clinic, we provide holistic treatment that addresses the root cause of this condition through natural remedies.
          </p>
        </section>
