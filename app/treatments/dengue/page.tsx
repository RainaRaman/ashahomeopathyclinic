...
export const metadata = {
  title: 'Dengue Fever Treatment | Asha Homeopathic Clinic',
...
export default function DenguePage() {
  return (
    <TreatmentLayout
      ...
      subtitle="Supportive homeopathic care for dengue fever"
      mainImage="/images/services/dengue.png"
      clinicImage="/images/clinic/aboutclinic_1.png"
    >
      <div className="space-y-8">
        <section>
          <h2 className="text-3xl font-bold text-primary mb-4">Understanding Dengue Fever Treatment</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            Dengue Fever Treatment is a common health condition that affects many people. At Asha Homeopathic Clinic, we provide holistic treatment that addresses the root cause of this condition through natural remedies.
          </p>
        </section>
