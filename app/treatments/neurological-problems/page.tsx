...
export const metadata = {
  title: 'Neurological Problems | Asha Homeopathic Clinic',
  description: 'Comprehensive treatment for various neurological disorders',
};

export default function NeurologicalProblemsPage() {
  return (
    <TreatmentLayout
      title="Neurological Problems"
      subtitle="Comprehensive treatment for various neurological disorders"
      mainImage="/images/services/neurological-problems.png"
      clinicImage="/images/clinic/aboutclinic_1.png"
    >
      <div className="space-y-8">
        <section>
          <h2 className="text-3xl font-bold text-primary mb-4">Understanding Neurological Problems</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            Neurological Problems is a common health condition that affects many people. At Asha Homeopathic Clinic, we provide holistic treatment that addresses the root cause of this condition through natural remedies.
          </p>
        </section>
