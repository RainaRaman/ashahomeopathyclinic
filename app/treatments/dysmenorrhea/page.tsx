...
export const metadata = {
  title: 'Dysmenorrhea Treatment | Asha Homeopathic Clinic',
  description: 'Natural treatment for painful periods and menstrual disorders',
};

export default function DysmenorrheaPage() {
  return (
    <TreatmentLayout
      title="Dysmenorrhea Treatment"
      subtitle="Natural treatment for painful periods and menstrual disorders"
      mainImage="/images/services/dysmenorrhea.png"
      clinicImage="/images/clinic/aboutclinic_1.png"
    >
      <div className="space-y-8">
        <section>
          <h2 className="text-3xl font-bold text-primary mb-4">Understanding Dysmenorrhea Treatment</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            Dysmenorrhea Treatment is a common health condition that affects many people. At Asha Homeopathic Clinic, we provide holistic treatment that addresses the root cause of this condition through natural remedies.
          </p>
        </section>
