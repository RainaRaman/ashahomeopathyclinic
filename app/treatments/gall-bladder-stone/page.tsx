...
export const metadata = {
  title: 'Gall Bladder (Biliary) Stone Treatment | Asha Homeopathic Clinic',
  description: 'Natural homeopathic solutions for gallbladder stones',
};

export default function GallBladderStonePage() {
  return (
    <TreatmentLayout
      title="Gall Bladder (Biliary) Stone Treatment"
      subtitle="Natural homeopathic solutions for gallbladder stones"
      mainImage="/images/services/gall-bladder-stone.png"
      clinicImage="/images/clinic/aboutclinic_1.png"
    >
      <div className="space-y-8">
        <section>
          <h2 className="text-3xl font-bold text-primary mb-4">Understanding Gall Bladder (Biliary) Stone Treatment</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            Gall Bladder (Biliary) Stone Treatment is a common health condition that affects many people. At Asha Homeopathic Clinic, we provide holistic treatment that addresses the root cause of this condition through natural remedies.
          </p>
        </section>
