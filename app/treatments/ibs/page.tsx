...
export const metadata = {
  title: 'Irritable Bowel Syndrome (IBS) Treatment | Asha Homeopathic Clinic',
...
export default function IbsPage() {
  return (
    <TreatmentLayout
      ...
      subtitle="Natural homeopathic treatment for IBS and digestive disorders"
      mainImage="/images/services/ibs.png"
      clinicImage="/images/clinic/aboutclinic_1.png"
    >
      <div className="space-y-8">
        <section>
          <h2 className="text-3xl font-bold text-primary mb-4">Understanding Irritable Bowel Syndrome (IBS) Treatment</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            Irritable Bowel Syndrome (IBS) Treatment is a common health condition that affects many people. At Asha Homeopathic Clinic, we provide holistic treatment that addresses the root cause of this condition through natural remedies.
          </p>
        </section>
