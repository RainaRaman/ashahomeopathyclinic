...
export const metadata = {
  title: 'Gastritis Treatment | Asha Homeopathic Clinic',
...
export default function GastritisPage() {
  return (
    <TreatmentLayout
      ...
      subtitle="Effective homeopathic remedies for gastritis and stomach inflammation"
      mainImage="/images/services/gastritis.png"
      clinicImage="/images/clinic/aboutclinic_1.png"
    >
      <div className="space-y-8">
        <section>
          <h2 className="text-3xl font-bold text-primary mb-4">Understanding Gastritis Treatment</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            Gastritis Treatment is a common health condition that affects many people. At Asha Homeopathic Clinic, we provide holistic treatment that addresses the root cause of this condition through natural remedies.
          </p>
        </section>
